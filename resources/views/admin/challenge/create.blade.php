        ...
        <div class="container mx-auto px-6 py-8">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                <div class="p-8">
                    ...
                    <form method="POST" action="{{ route('admin.challenge.store') }}" class="space-y-6">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Challenge Title</label>
                                <input type="text" name="title" class="w-full px-3 py-2 border rounded-md focus:ring-2" required>
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4" class="w-full px-3 py-2 border rounded-md focus:ring-2" required></textarea>
                        </div>
        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Challenge Requirements</label>
                            <textarea name="requirements" rows="4" class="w-full px-3 py-2 border rounded-md focus:ring-2" required></textarea>
                        </div>
        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Evaluation Criteria</label>
                            <textarea name="evaluation_criteria" rows="4" class="w-full px-3 py-2 border rounded-md focus:ring-2" required></textarea>
                        </div>
        
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Start Date</label>
                                <input type="date" name="start_date" class="w-full px-3 py-2 border rounded-md focus:ring-2" required>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">End Date</label>
                                <input type="date" name="end_date" class="w-full px-3 py-2 border rounded-md focus:ring-2" required>
                            </div>
                        </div>
        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Prize Description</label>
                            <input type="text" name="prize_description" class="w-full px-3 py-2 border rounded-md focus:ring-2" required>
                        </div>
