    ...
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md border">
        ...
        <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="file" id="company_logo" name="company_logo" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                
                @if($user->company_logo)
                    <div class="mt-3">
                        <img src="{{ asset($user->company_logo) }}" alt="Company Logo" class="w-24 h-24 object-cover rounded-md">
                    </div>
                @endif
            </div>
    
            <button type="submit" class="w-full bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition duration-300">Simpan Perubahan</button>
        </form>
    </div>
